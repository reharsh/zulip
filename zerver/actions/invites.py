...
def get_invite_controlled_by_user(prereg_user: PreregistrationUser, user_profile: UserProfile) -> dict[str,Any]:
    """
    Returns the Invite representing invitation that can be controlled by user_profile.
    This isn't necessarily the same as all the invitations generated by the user, as administrators
    can control also invitations that they did not themselves create.
    """
    invitee = prereg_user;
...
def get_multiuse_invite_controlled_by_user(invite: MultiuseInvite, user_profile: UserProfile)-> dict[str,Any]:
    """
    Returns a Multiuse Invite representing invitation that can be controlled by user_profile.
    This isn't necessarily the same as all the invitations generated by the user, as administrators
    can control also invitations that they did not themselves create.
    """
    invite_id=invite.id
